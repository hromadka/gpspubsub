...
data type Position from gpspubsub.idl.
This example builds two applications, named gpspubsub_publisher and
gpspubsub_subscriber.
...
> make -f makefile_gpspubsub_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_gpspubsub_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the gpspubsub_publisher.cxx
file where it says:
...
> objs/x64Linux4gcc7.3.0/gpspubsub_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/gpspubsub_subscriber -d <domain_id> -s <sample_count>
