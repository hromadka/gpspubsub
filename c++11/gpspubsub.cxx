...
Position::Position(Position&& other_) OMG_NOEXCEPT  :m_providerID_ (std::move(other_.m_providerID_))
,
m_lat_ (std::move(other_.m_lat_))
,
...
std::ostream& operator << (std::ostream& o,const Position& sample)
{
    ...
    o <<"[";
    o << "providerID: " << sample.providerID()<<", ";
    ...
    namespace topic {
        ...
        struct native_type_code< Position > {
            static DDS_TypeCode * get()
            {
                ...
                Position_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
                ...
                Position_g_tc_members[0]._annotations._defaultValue._d = RTI_XCDR_TK_LONG;
                Position_g_tc_members[0]._annotations._defaultValue._u.long_value = 0;
                Position_g_tc_members[0]._annotations._minValue._d = RTI_XCDR_TK_LONG;
                Position_g_tc_members[0]._annotations._minValue._u.long_value = RTIXCdrLong_MIN;
                Position_g_tc_members[0]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                Position_g_tc_members[0]._annotations._maxValue._u.long_value = RTIXCdrLong_MAX;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                (RTIXCdrUnsignedLong) ((char *)&sample->providerID() - (char *)sample);
