...
#ifndef gpspubsubPlugin_794216703_h
#define gpspubsubPlugin_794216703_h
...
* AnotherSimple.
*
* By default, this type is struct Position
* itself. However, if for some reason this choice is not practical for your
* system (e.g. if sizeof(struct Position)
* is very large), you may redefine this typedef in terms of another type of
* your choosing. HOWEVER, if you define the KeyHolder type to be something
* other than struct AnotherSimple, the
* following restriction applies: the key of struct
* Position must consist of a
* single field of your redefined KeyHolder type and that field must be the
* first field in struct Position.
*/
typedef  class Position PositionKeyHolder;
...
#define PositionPlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
#define PositionPlugin_return_key PRESTypePluginDefaultEndpointData_returnKey
...
NDDSUSERDllExport extern Position*
PositionPluginSupport_create_key_ex(RTIBool allocate_pointers);

NDDSUSERDllExport extern Position*
PositionPluginSupport_create_key(void);

NDDSUSERDllExport extern void 
PositionPluginSupport_destroy_key_ex(
    PositionKeyHolder *key,RTIBool deallocate_pointers);

NDDSUSERDllExport extern void 
PositionPluginSupport_destroy_key(
    PositionKeyHolder *key);
...
NDDSUSERDllExport extern RTIBool 
PositionPlugin_instance_to_key(
    PRESTypePluginEndpointData endpoint_data,
    PositionKeyHolder *key, 
    const Position *instance);

NDDSUSERDllExport extern RTIBool 
PositionPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    Position *instance, 
    const PositionKeyHolder *key);

NDDSUSERDllExport extern RTIBool 
PositionPlugin_serialized_sample_to_keyhash(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
...
#endif /* gpspubsubPlugin_794216703_h */
